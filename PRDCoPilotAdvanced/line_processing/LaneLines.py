...
class LaneLines:
    ...
    def __init__(self):
        ...
        self.dir = []
        self.left_curve_img = mpimg.imread('turns_pics/left_turn.png')
        self.right_curve_img = mpimg.imread('turns_pics/right_turn.png')
        self.keep_straight_img = mpimg.imread('turns_pics/straight.png')
    ...
    def fit_poly(self, img):
        ...
        for i, y in enumerate(ploty):
            ...
            r = int(right_fitx[i])
            y = int(y)
            cv2.line(out_img, (l, y), (r, y), (0, 100, 0))
